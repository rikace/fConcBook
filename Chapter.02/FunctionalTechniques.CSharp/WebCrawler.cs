...
namespace FunctionalTechniques.CSharp
{
    ...
    public class WebCrawlerExample
    {
        ...
        public static void RunDemo()
        {
            ...
            Bench.Time("Listing 2.17 Web crawler execution", () =>
            {
            ...
            Bench.Time("Listing 2.18 Web crawler execution using memoization", () =>
            {
                var webPageTitles = from url in urls //#B
            ...
            Bench.Time("Listing 2.19 Web crawler query using PLINQ", () =>
            {
            ...
            Bench.Time("Listing 2.20 Thread-safe memoization function", () =>
            {
