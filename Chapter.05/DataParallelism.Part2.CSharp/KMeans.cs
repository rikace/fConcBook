...
{
    public class KMeansPLinqPartition
    {
        protected double[][] data;

        protected int N;

        public KMeansPLinqPartition(double[][] data)
        {
            this.data = data;
            N = data[0].Length;
        }
        ...
        private double[][] UpdateCentroidsWithMutableState(double[][] centroids)
        {
    ...
    public class KMeansLinq : KMeansPLinqPartition
    {
    ...
    public class KMeansPLinq : KMeansPLinqPartition
    {
