...
//John Conway's Game of Life is a famous example of a simple cellular automaton that produces remarkably diverse results.
//The game can be implemented in only 32 lines of F# including real-time
//visualization using Windows Presentation Foundation as follows:
