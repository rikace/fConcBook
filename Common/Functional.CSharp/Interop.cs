...
namespace Functional.CSharp
{
    public static class Interop
    {
        ...
        public static FSharpFunc<Tuple<A1, A2, A3>, Result> ToTupledFSharpFunc<A1, A2, A3, Result>(
            this Func<A1, A2, A3, Result> f)
        {
            return FuncConvert.ToFSharpFunc(
                new Converter<Tuple<A1, A2, A3>, Result>(t => f(t.Item1, t.Item2, t.Item3)));
        }
    }
}