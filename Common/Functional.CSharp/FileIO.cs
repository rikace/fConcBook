...
namespace Functional.CSharp
{
    public static class File
    {
        ...
        public static FileStream OpenReadAsync(string path, int bufferSize = BUFFER_SIZE)
        {
        ...
        public static FileStream OpenWriteAsync(string path, int bufferSize = BUFFER_SIZE)
        {
        ...
        {
            using (var stream = OpenWriteAsync(path))
            {
